...
export const FileUpload = ({ onChange, title, description }: FileUploadProps) => {
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center">
          <p className="relative z-20 font-sans font-bold text-neutral-700 dark:text-neutral-300 text-base">
            {title || "Mettez votre meilleur image !"}
          </p>
          <p className="relative z-20 font-sans font-normal text-neutral-400 dark:text-neutral-400 text-base mt-2">
            {description || "Mets à jour ton image et deviens la star de ta page !"}
          </p>
          {
            error && (
                ...
                >
                  <div className="flex justify-between w-full items-center gap-4">
                    <motion.p
                      ...
                      animate={{opacity: 1}}
                      layout
                      className="text-base text-neutral-700 dark:text-neutral-300 truncate max-w-xs text-center w-full"
                    >
                      {file.name}
                    </motion.p>
